...
!(function () {
  ...
  var ANIMDISTANCE = 0.035, // Rotation animation threshold, ~2deg in radians
    ...
    zoomlevel = 1; // Default zoom level, 1 = 100%  // MINE !
  ...
  */
  ...
  if (typeof module === "object" && module.exports) {
    var d3js = require("./lib/d3.js.js"),
      d3_geo_projection = require("./lib/d3.geo.projection.js.js");
    module.exports = {
      Celestial: function () {
        return Celestial;
      },
...
*/
  ...
  function geo(cfg) {
    ...
    // showAdvanced(config.advanced); /* mine */
...
*/
  ...
  var Kepler = function () {
    ...
    function equatorial(pos) {
      ...
      cosε = Math.cos(ε);
      var o =
        id === "lun" ? { x: 0, y: 0, z: 0 } : { x: pe.x, y: pe.y, z: pe.z };
      de.xeq = de.x - o.x;
