...
function Map() {
  const config = {
    ...
    projection: "armadillo", // Map projection used: airy, aitoff, armadillo, august, azimuthalEqualArea, azimuthalEquidistant, baker, berghaus, boggs, bonne, bromley, collignon, craig, craster, cylindricalEqualArea, cylindricalStereographic, eckert1, eckert2, eckert3, eckert4, eckert5, eckert6, eisenlohr, equirectangular, fahey, foucaut, ginzburg4, ginzburg5, ginzburg6, ginzburg8, ginzburg9, gringorten, hammer, hatano, healpix, hill, homolosine, kavrayskiy7, lagrange, larrivee, laskowski, loximuthal, mercator, miller, mollweide, mtFlatPolarParabolic, mtFlatPolarQuartic, mtFlatPolarSinusoidal, naturalEarth, nellHammer, orthographic, patterson, polyconic, rectangularPolyconic, robinson, sinusoidal, stereographic, times, twoPointEquidistant, vanDerGrinten, vanDerGrinten2, vanDerGrinten3, vanDerGrinten4, wagner4, wagner6, wagner7, wiechel, winkel3
    ...
    datapath: "../public/celestial/data/", // Path/URL to data files, empty = subfolder 'data' - par rapport a HTML !
    stars: {
    ...
    constellations: {
      ...
      boundstyle: { stroke: "#cccc00", width: 0.7, opacity: 0.8, dash: [2, 5] },
    },
    planets: {
      show: false,
      names: false,
  ...
  return <div id="celestial-map"></div>;
}
